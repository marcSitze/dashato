    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
          <div>
            <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base">
              {t.grossRevenueGrowthTimeline || 'Gross Revenue & Growth Timeline'}
            </h3>
            <p className="text-xs text-slate-400">
              {t.monthlyRevenueTrend || 'Monthly revenue trend across all vendor stores'}
            </p>
          </div>
          <span className="text-xs font-bold text-amber-600 dark:text-amber-400 bg-amber-500/10 px-2.5 py-1 rounded-xl border border-amber-500/20">
            {t.financialYear || '2026 Financial Year'}
          </span>
        </div>
      ...
      <div className="lg:col-span-4 bg-white dark:bg-slate-900 rounded-3xl p-6 border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
        <div className="border-b border-slate-100 dark:border-slate-800 pb-3">
          <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base">
            {t.categoryMarketShare || 'Category Market Share'}
          </h3>
          <p className="text-xs text-slate-400">
            {t.departmentDistribution || 'Department distribution by sales volume'}
          </p>
        </div>
