      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pb-12 border-b border-slate-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="font-bold text-white text-sm">Free Global Shipping</h5>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="font-bold text-white text-sm">Safe & Secure Payment</h5>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h5 className="font-bold text-white text-sm">24/7 Dedicated Support</h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 py-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="pt-2">
              <h6 className="font-semibold text-white text-xs mb-2">Subscribe to Exclusive Flash Sales</h6>
              <div className="flex gap-2 max-w-sm">
                <input
                  type="email"
                  placeholder="Enter your email address..."
                  className="bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-xs text-white placeholder:text-slate-600 focus:outline-none focus:border-amber-500 flex-1"
                />
                <button className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs px-4 py-2 rounded-xl transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          {/* Customer Support */}
          <div className="space-y-3">
            <h6 className="font-bold text-white text-xs uppercase tracking-wider">Customer Care</h6>
            <ul className="space-y-2 text-xs">
              <li><Link href="/account" className="hover:text-amber-400">My Account & Orders</Link></li>
              <li><Link href="/account/orders" className="hover:text-amber-400">Track Order Status</Link></li>
              <li><Link href="/account/wishlist" className="hover:text-amber-400">Saved Wishlist</Link></li>
              <li><Link href="/checkout" className="hover:text-amber-400">Shopping Cart & Checkout</Link></li>
              <li><Link href="/help" className="hover:text-amber-400">Help Center & Buyer Protection</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="/vendor/apply" className="text-amber-400 font-semibold hover:underline">Become a Verified Vendor</Link></li>
              <li><Link href="/vendor" className="hover:text-amber-400">Vendor Seller Center</Link></li>
              <li><Link href="/admin" className="hover:text-amber-400">Platform Admin Dashboard</Link></li>
              <li><Link href="/login" className="hover:text-amber-400">User Sign In / Register</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} Dashato Inc. All rights reserved. Built with Next.js App Router, Prisma, & Tailwind CSS.</p>
          <div className="flex items-center gap-3">
