                  ...
                  <>
                    ...
                    {session.user.role === 'ADMIN' && (
                      <DropdownMenuItem onClick={() => router.push('/admin')}>
                        <LayoutDashboard className="w-4 h-4 mr-2 text-amber-500" /> {t.adminDashboard}
                      </DropdownMenuItem>
                    )}
                    ...
                    <DropdownMenuItem onClick={() => router.push('/account')}>
                      <Package className="w-4 h-4 mr-2 text-slate-500" /> {t.myAccount}
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
      ...
      <nav className="hidden lg:block bg-slate-100 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 py-2.5 px-4 text-xs">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-slate-500 dark:text-slate-400">
            <Link href="/products?sort=best_selling" className="hover:text-amber-500">{t.bestSellers}</Link>
            <Link href="/products?sort=newest" className="hover:text-amber-500">{t.newArrivals}</Link>
